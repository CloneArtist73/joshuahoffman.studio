...
export const products: ProductItem[] = [
  {
    ...
    routeKeys: ['afterTheShowFineArtAmerica', 'afterTheShowEtsy'],
    inquiryAllowed: true,
  },
  {
    ...
    routeKeys: ['kitchenWindowFineArtAmerica', 'kitchenWindowPixieset'],
    inquiryAllowed: true,
  },
  {
    ...
    routeKeys: ['quietAmpShopify', 'quietAmpPixieset'],
    inquiryAllowed: true,
  },
  {
    ...
    routeKeys: ['roomWithFlowersFineArtAmerica', 'roomWithFlowersEtsy'],
    inquiryAllowed: true,
  },
];
